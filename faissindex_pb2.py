...
_DIMENSIONRESPONSE = _descriptor.Descriptor(
  ...
  full_name='faiss_index.DimensionResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='dim', full_name='faiss_index.DimensionResponse.dim', index=0,
      number=1, type=3, cpp_type=2, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
SearchByEmbeddingRequest = _reflection.GeneratedProtocolMessageType('SearchByEmbeddingRequest', (_message.Message,), {
...
DimensionResponse = _reflection.GeneratedProtocolMessageType('DimensionResponse', (_message.Message,), {
  'DESCRIPTOR' : _DIMENSIONRESPONSE,
  '__module__' : 'faissindex_pb2'
  # @@protoc_insertion_point(class_scope:faiss_index.DimensionResponse)
  })
...
_SERVER = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='Dimension',
    full_name='faiss_index.Server.Dimension',
    index=7,
    containing_service=None,
    input_type=_EMPTYREQUEST,
